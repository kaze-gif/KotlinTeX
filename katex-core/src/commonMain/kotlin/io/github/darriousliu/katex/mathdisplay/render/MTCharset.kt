...
import io.github.darriousliu.katex.mathdisplay.parse.MTFontStyle
import io.github.darriousliu.katex.mathdisplay.parse.MathDisplayException
import io.github.darriousliu.katex.utils.codePointToChars
...
internal class MTCodepointChar(val codepoint: Int) {
    fun toUnicodeString(): String {
        val cs = codepoint.codePointToChars()
